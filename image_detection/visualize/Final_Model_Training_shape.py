...
class Config:
    ...
    OUTPUT_IMG_DIR = os.path.join(SCRIPT_DIR, "Final_Model_Training_shape")
    OUTPUT_CSV_PATH = os.path.join(SCRIPT_DIR, "Final_Model_Training_shape/Detection_Metrics.csv")
