...
class Config:
    ...
    MODEL_PATH = os.path.join(os.path.dirname(SCRIPT_DIR), "Comparison_And_Ablation_Runs/02_Structure_UNetPP/best.pth")
...
if __name__ == "__main__":
    ...
    model = smp.UnetPlusPlus(encoder_name="resnet34", encoder_weights=None, in_channels=3, classes=2)
